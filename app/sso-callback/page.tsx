...
export default function SSOCallbackPage() {
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#020617] p-4 relative overflow-hidden">
      {/* Efeito de Brilho Neon Centralizado */}
      ...
      <div className="w-full max-w-md space-y-8 rounded-3xl border border-white/10 bg-slate-900/40 p-8 shadow-2xl backdrop-blur-xl z-10 text-center">
        ...
        <div className="flex flex-col items-center justify-center space-y-6 py-6">
          {/* Spinner de carregamento personalizado com as cores do projeto */}
        ...
        {/* O Componente invisível do Clerk que processa o login.
          Mudámos o fallback para "/dashboard" para garantir que o 
          utilizador vai para o painel principal após o sucesso.
        */}
